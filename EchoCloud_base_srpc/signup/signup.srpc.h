...
namespace signup
{
	...
	namespace SignupService
	{
		...
		{
		public:
			void Signup(const ReqSignup *req, SeriesWork *series, SignupDone done);
		...
		inline Service::Service() : srpc::RPCService("signup.SignupService")
		{
		...
		inline SRPCClient::SRPCClient(const char *host, unsigned short port) : srpc::SRPCClient("signup.SignupService")
		{
		...
		inline SRPCClient::SRPCClient(const struct srpc::RPCClientParams *params) : srpc::SRPCClient("signup.SignupService")
		{
		...
		inline void SRPCClient::Signup(const ReqSignup *req, SeriesWork *series, SignupDone done)
		{
		...
		inline SRPCHttpClient::SRPCHttpClient(const char *host, unsigned short port) : srpc::SRPCHttpClient("signup/SignupService")
		{
			struct srpc::RPCClientParams params = srpc::RPC_CLIENT_PARAMS_DEFAULT;
		...
		inline SRPCHttpClient::SRPCHttpClient(const struct srpc::RPCClientParams *params) : srpc::SRPCHttpClient("signup/SignupService")
		{
			const struct srpc::RPCClientParams *temp = params;
			struct srpc::RPCClientParams temp_params;
		...
		inline BRPCClient::BRPCClient(const char *host, unsigned short port) : srpc::BRPCClient("signup.SignupService")
		{
			struct srpc::RPCClientParams params = srpc::RPC_CLIENT_PARAMS_DEFAULT;
		...
		inline BRPCClient::BRPCClient(const struct srpc::RPCClientParams *params) : srpc::BRPCClient("signup.SignupService")
		{
			const struct srpc::RPCClientParams *temp = params;
			struct srpc::RPCClientParams temp_params;
		...
		inline TRPCClient::TRPCClient(const char *host, unsigned short port) : srpc::TRPCClient("signup.SignupService")
		{
			struct srpc::RPCClientParams params = srpc::RPC_CLIENT_PARAMS_DEFAULT;
		...
		inline TRPCClient::TRPCClient(const struct srpc::RPCClientParams *params) : srpc::TRPCClient("signup.SignupService")
		{
			const struct srpc::RPCClientParams *temp = params;
			struct srpc::RPCClientParams temp_params;
		...
		{
			auto *task = this->create_rpc_client_task("/signup.SignupService/Signup", std::move(done));
		...
		inline WFFuture<std::pair<RespSignup, srpc::RPCSyncContext>> TRPCClient::async_Signup(const ReqSignup *req)
		{
			...
			auto *pr = new WFPromise<RESULT>();
			auto fr = pr->get_future();
			auto *task = this->create_rpc_client_task<RespSignup>("/signup.SignupService/Signup", srpc::RPCAsyncFutureCallback<RespSignup>);
		...
		inline TRPCHttpClient::TRPCHttpClient(const char *host, unsigned short port) : srpc::TRPCHttpClient("signup.SignupService")
		{
			struct srpc::RPCClientParams params = srpc::RPC_CLIENT_PARAMS_DEFAULT;
		...
		inline TRPCHttpClient::TRPCHttpClient(const struct srpc::RPCClientParams *params) : srpc::TRPCHttpClient("signup.SignupService")
		{
			const struct srpc::RPCClientParams *temp = params;
			struct srpc::RPCClientParams temp_params;
